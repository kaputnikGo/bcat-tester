...
// get all the register bits
void smi_special_modes_reg_state(REFERENCE_PARAM(smi_interface_t, smi), char *modes);
// check phy for mii or rmii modes
int smi_miimode_check_state(REFERENCE_PARAM(smi_interface_t, smi));
