...
#define ETHERNET_MAX_TX_HP_PACKET_SIZE (100 + AVB_BCAT_NUM_CHANNELS * 24)
...
#define AVB_MAX_CHANNELS_PER_TALKER_STREAM AVB_BCAT_NUM_CHANNELS
/** The maximum number of channels permitted per 1722 Listener stream */
#define AVB_MAX_CHANNELS_PER_LISTENER_STREAM AVB_BCAT_NUM_CHANNELS
...
// deprecated vendorID use, 64 bit field entity_model_id is used.
// keep it here for this version of modules, derived from BCAT board 5 MAC address
// #define AVB_1722_1_ADP_VENDOR_ID 0x00229700u // <- xmos vendor id
#define AVB_1722_1_ADP_VENDOR_ID 0x00099D00u
#define AVB_1722_1_ADP_MODEL_ID 0x0005
